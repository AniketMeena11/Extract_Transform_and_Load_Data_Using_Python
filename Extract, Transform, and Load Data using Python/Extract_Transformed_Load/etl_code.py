...
# with open('ETL/source.zip', 'wb') as file:
...
target_file = 'transformed_data'

# task 1. Extraction 

# function for extract csv 
...
# Testsing ETL operations and log progress 
